      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap text-gray-900">Kanban</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap text-gray-900">Users</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap text-gray-900">Products</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap text-gray-900">Sign In</span>
            </a>
         </li>
...
<div className="p-4 sm:ml-64">
   <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg  mt-14 pt-1 pb-12">

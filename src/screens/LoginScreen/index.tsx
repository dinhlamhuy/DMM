...
const LoginScreen: React.FC = () => {
    ...
    let eyesCovered: boolean, bodyBGchanged: any, Power2: { easeInOut: any; };
    let armL = document.querySelector('.armL'), armR = document.querySelector('.armR'),
        ...
        tongue = document.querySelector('.tongue'), tooth=document.querySelector('.tooth'),chin = document.querySelector('.chin'), face = document.querySelector('.face'), eyebrow = document.querySelector('.eyebrow'),
        outerEarL = document.querySelector('.earL .outerEar'), outerEarR = document.querySelector('.earR .outerEar'), earHairL = document.querySelector('.earL .earHair'), earHairR = document.querySelector('.earR .earHair'),
        hair = document.querySelector('.hair'), bodyBG = document.querySelector('.bodyBGnormal');
    let  screenCenter: number,
        emailCoords: { x: any; y: number; }, emailScrollMax: number, chinMin = .5, dFromC: number;

    let eyeLCoords: { x: any; y: any; }, eyeRCoords: { x: any; y: any; }, noseCoords: { x: any; y: any; }, mouthCoords: { x: any; y: any; }, eyeLAngle, eyeLX, eyeLY, twoFingers: gsap.TweenTarget,
        eyeRAngle, eyeRX, eyeRY, noseAngle, noseX, noseY, mouthAngle, mouthX, mouthY, mouthR, chinX, chinY, chinS, faceX, faceY, faceSkew, eyebrowSkew, outerEarX, outerEarY, hairX, hairS;
    ...
    const handlePasswordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Add the logic for face movement here (if needed)
    };
    ...
    function spreadFingers() {
        ...
        TimelineMax.to(twoFingers, .35, { transformOrigin: "bottom left", rotation: 30, x: -9, y: -2, ease: Power2.easeInOut });
    }
    ...
    function calculateFaceMove() {
        ...
        if (emails.length <= emailScrollMax) {
          ;
    ...
    return (
        <div className=" bg-gray-50 h-screen w-screen items-center justify-center flex ">
            <div className="container px-1.5 py-2 w-4/5 xs:w-4/5  md:w-3/5 lg:w-3/5 xl:w-2/5  h-3/4  
        place-items-center place-content-center bg-gray-200 shadow-lg border-7  rounded-lg ">
                <form>
                    ...
                    <div className="inputGroup inputGroup1">
                        ...
                        <input
                            type="email"
                            id="loginEmail"
                            value={emails} className={`${EmailClass}`} onChange={handleEmailChange}
                    ...
                    <div className="inputGroup inputGroup2">
                        ...
                        <input
                            ...
                            id="loginPassword" onChange={handlePasswordChange}
                            value={passwords} onFocus={onPasswordFocus}
                            />
